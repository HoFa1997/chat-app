...
type TMsgPaginnatedArg =
  Database["public"]["Functions"]["get_channel_messages_paginated"]["Args"];
type TMsgPaginnatedReturn =
  Database["public"]["Functions"]["get_channel_messages_paginated"]["Returns"][
    0
  ];
...
export const fetchMessagesPaginated = async (
  arg: TMsgPaginnatedArg,
): Promise<Tmsg> => {
