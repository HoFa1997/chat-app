...
CREATE TABLE public.pinned_messages (
    ...
    message_id    VARCHAR(36) NOT NULL REFERENCES public.messages ON DELETE CASCADE, -- The ID of the message that is pinned.
...
-- Function to create a notification message when a user joins a channel
